...
class Buy_Order:
    def __init__(self) -> None:
        ...
        config = json.load(open('BuyFutureConfig.json'))
    ...
    def create_config_file(self):
        ...
        with open("../BuyFutureConfig.json", "w") as f:
            f.write(file)
            f.close()
    ...
    def place_order_1(self):
        ...
        try:
            ...
            while True:
                ...
                print('Order still not placed with LTP -', ltp)
                config = json.load(open('BuyFutureConfig.json'))
                time.sleep(1)
                if str(ltp) <= config['limitPrice1']:
        ...
        while intrade == 1:
            ...
            config1 = json.load(open('BuyFutureConfig.json'))
