    ...
    def place_order_1(self):
        ...
        try:
            while True:
                ...
                print('Order still not placed in place_order 1 for ', self.symbol, 'with LTP -', ltp, ' and with LIMIT Price1 - ',
                      self.limitPrice1)
        ...
        while intrade == 1:
            ...
            print('self.stop_loss1', config1['stop_loss1'])
    ...
    def place_order_2(self):
        ...
        try:
            ...
            while True:
                ...
                print('Order still not placed in place_order2 for ', self.symbol, 'with LTP -', ltp, ' and with LIMIT Price2 -',
                      self.limitPrice2)
                print('current time--', time.strftime('%H:%M:%S'))
                config4 = json.load(open('Sell_config.json'))
