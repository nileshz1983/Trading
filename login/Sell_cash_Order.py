...
class Sell_Order:
    ...
    def __init__(self) -> None:
        ...
        global config
        try:
            if not os.path.join(os.getcwd().join('SellOptionConfig.json'.strip())):
        ...
        config = json.load(open('SellOptionConfig.json'))
        ...
        if self.username == '' or self.client_id == '' or self.secret_key == '' or self.totp_key == '' or self.redirect_url == '' or self.target1 == '' or self.target2 == '' or self.stop_loss1 == '' or self.stop_loss2 == '' or self.quantity1 == '' or self.quantity2 == '' or self.stopLoss_count == '':
            ...
            print('please enter all the details in the SellOptionConfig.json file')
            exit()

    def create_config_file(self):
        file = json.dumps(config, indent=10)
        with open("../SellOptionConfig.json", "w") as f:
            f.write(file)
            f.close()
    ...
    def place_order_1(self, stopLossList):
        ...
        try:
            ...
            while Flag:
                ...
                time.sleep(1)
                config5 = json.load(open('SellOptionConfig.json'))
        ...
        while intrade == 1:
            ...
            time.sleep(1)
            config1 = json.load(open('SellOptionConfig.json'))
    ...
    def place_order_2(self):
        ...
        try:
            ...
            while Flag:
                ...
                print('current time--', time.strftime('%H:%M:%S'))
                time.sleep(1)
                config4 = json.load(open('SellOptionConfig.json'))
